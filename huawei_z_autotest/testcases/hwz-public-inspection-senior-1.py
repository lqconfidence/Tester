...
# @Author:a'nan
# @Email:934257271
# @File:hwz_public_inspection_senior.py
...
if rem == 0:
    ...
    for i in range(0, len, step):
        for j in range(i, i + step):
            ...
            try:
                ...
                excel_hw_zhongduan.write(sheet_name=sheet_name, row=row, column=8, data=task_id)
    ...
    for i in range(0, mod * step, step):
        ...
        for j in range(i, i + step):
            ...
            if "None" in privacyurl:
                privacyurl = privacyurl.replace('None', '')
            print(apptype,flag,introduction,privacyurl)
            request_body = {"request": [{"md5": md5, "url": apk_url, "type": ["secret", "conformance"],
                                         "options": {
                                             "secret": {
                                                 "apptype": apptype,
