...
from common.excel_handler import excel_prod

sheet_name = 'hwz_inspection_prod'

test_datas = excel_prod.read(sheet_name)



@ddt.ddt
class TestPaInspectionProd(unittest.TestCase):
    ...
    @ddt.data(*test_datas)
    def test_inspection_pa_prod(self, test_data):
        ...
        excel_prod.write(sheet_name, test_data['case_id'] + 1, 8, str(task_id))
        time.sleep(600)
