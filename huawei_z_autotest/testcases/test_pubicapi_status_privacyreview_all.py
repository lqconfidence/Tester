...
head_data = excel_hw_privacyreview_all.header(sheet_name)
...
test_datas = excel_hw_privacyreview_all.read(sheet_name)

@ddt.ddt
class TestPrivacyReview(unittest.TestCase):
